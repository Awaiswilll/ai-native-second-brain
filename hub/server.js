...
async function getStatus() {
  ...
  return {
    ...
    tools: {
      ...
      newelle: { available: newelle }, alpaca: { available: alpaca }, claude: { available: claude }, codex: { available: codex }, grok: { available: grok }, potpie: { available: potpie }, deepsec: { available: deepsec }, squad: { available: squad }, understand: { available: understand },
